...
function reload(){
    ...
    if (twohanded){
        ...
        // Circular Motion
            ...
            var zigzag_size = document.getElementById('zigzag_size');
            circularmotion.setAttribute('zigzag_size',zigzag_size.value);
            var zigzag_style = document.getElementById('zigzag_style');
            circularmotion.setAttribute('zigzag_style',zigzag_style.value);
        ...
        // var lrpt = xmlDoc.getElementsByTagName('rpt_motion')[1];

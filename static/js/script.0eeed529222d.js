...
function reload(){
    ...
    if (twohanded){
        ...
        var selected = handshape.options[handshape.selectedIndex];
        $split_handconfig.append(selected.getAttribute('data'));

        var lhandshape = document.getElementById('l_handshape');
        var selected = lhandshape.options[lhandshape.selectedIndex];
        $split_handconfig.append(selected.getAttribute('data'));
        ...
        var handshape = document.getElementById('handshape');
        var selected = handshape.options[handshape.selectedIndex];
        $sign_manual.append(selected.getAttribute('data'));
        var handconfig = xmlDoc.getElementsByTagName('handconfig')[0];

...
function updatesign(){
    ...
    // Specific Bending
    var bend1_attr =
        document.getElementByName('bend1_1').value + " " +
        document.getElementByName('bend1_2').value + " " +
        document.getElementByName('bend1_3').value + " " +
        document.getElementByName('bend1_4').value + " " +
        document.getElementByName('bend1_5').value;
    var bend2_attr =
        document.getElementByName('bend2_1').value + " " +
        document.getElementByName('bend2_2').value + " " +
        document.getElementByName('bend2_3').value + " " +
        document.getElementByName('bend2_4').value;
    var bend3_attr =
        document.getElementByName('bend3_1').value + " " +
        document.getElementByName('bend3_2').value + " " +
        document.getElementByName('bend3_3').value + " " +
        document.getElementByName('bend3_4').value;
    var bend4_attr = 
        document.getElementByName('bend4_1').value + " " +
        document.getElementByName('bend4_2').value + " " +
        document.getElementByName('bend4_3').value + " " +
        document.getElementByName('bend4_4').value;
    var bend5_attr = 
        document.getElementByName('bend5_1').value + " " +
        document.getElementByName('bend5_2').value + " " +
        document.getElementByName('bend5_3').value + " " +
        document.getElementByName('bend5_4').value;

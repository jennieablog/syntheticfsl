...
function updatesign(){
    ...
    var bend2_attr =
        document.getElementsByName('bend2_1').value + " " +
        document.getElementsByName('bend2_2').value + " " +
        document.getElementsByName('bend2_3').value + " " +
        document.getElementsByName('bend2_4').value;
    var bend3_attr =
        document.getElementsByName('bend3_1').value + " " +
        document.getElementsByName('bend3_2').value + " " +
        document.getElementsByName('bend3_3').value + " " +
        document.getElementsByName('bend3_4').value;
    var bend4_attr = 
        document.getElementsByName('bend4_1').value + " " +
        document.getElementsByName('bend4_2').value + " " +
        document.getElementsByName('bend4_3').value + " " +
        document.getElementsByName('bend4_4').value;
    var bend5_attr = 
        document.getElementsByName('bend5_1').value + " " +
        document.getElementsByName('bend5_2').value + " " +
        document.getElementsByName('bend5_3').value + " " +
        document.getElementsByName('bend5_4').value;
